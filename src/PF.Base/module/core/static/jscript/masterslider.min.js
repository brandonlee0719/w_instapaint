...
;(function($){
    ...
    p._init = function(){
        ...
        _debug && console.log("MasterSlider::_init");

        if(this.preventInit) return;

        _debug && console.log("MasterSlider::preventInit pass");
        ...
        this.$controlsCont = $('<div></div>').addClass('ms-inner-controls-cont').addClass('dont-unbind');//.appendTo(this.$element);
        ...
        _debug && console.log("MasterSlider::_init end");
    ...
    p.setup = function(id , options){
        ...
        console.log("MasterSlider.setup invoked");

        window.setTimeout(function(){that._init()},250);
...
;(function(){
    ...
    window.MSFadeWaveView = function(options){
        MSWaveView.call(this , options);
        this.$element.removeClass('ms-wave-view').addClass('ms-fade-wave-view').addClass('dont-unbind');
    };
