...
class Mail_Service_Mail extends Phpfox_Service
{
	...
	public function buildMenu()
	{
		...
		$aFilterMenu = array(
			...
			(Phpfox::getParam('mail.threaded_mail_conversation') ? _p('archive') : _p('trash')) . (isset($aCountFolders['iCountDeleted']) ? ' <span class="count-item">' . $aCountFolders['iCountDeleted'] . '</span>' : '') => 'trash'
		);
