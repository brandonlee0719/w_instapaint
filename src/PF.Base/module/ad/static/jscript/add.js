...
$Behavior.creatingAnAd = function()
{
	...
	*/
	...
	$('#title').keyup(function()
	{
		...
		{
			$('.ad_unit_multi_ad_title', '#js_sample_multi_ad_holder').html(strip_text($(this).val()).replace('<','&lt;').replace('>','&gt;') );
	...
	$('#body_text').keyup(function()
	{
		...
		if (oParams['ad.multi_ad'])
		{
			$('.ad_unit_multi_ad_text', '#js_sample_multi_ad_holder').html(strip_text($(this).val()).replace('<','&lt;').replace('>','&gt;') );
			$('#js_sample_multi_ad_holder').show();
	...
	if (oParams['ad.multi_ad'])
	{
		$('#url_link').on('change keyup', function(){
			$('.ad_unit_multi_ad_url', '#js_sample_multi_ad_holder').html( $(this).val() );
			$('#js_sample_multi_ad_holder').show();
		})
		.blur(function(){
			$('.ad_unit_multi_ad_url', '#js_sample_multi_ad_holder').html( $('.ad_unit_multi_ad_url', '#js_sample_multi_ad_holder').html().replace('http://','').replace('<','&lt;').replace('>','&gt;') );
		})
		.focus(function(){
