			...
			<div class="comment_mini_action">
				<ul>
					{if Phpfox::getParam('comment.comment_is_threaded') && Phpfox::getUserParam('feed.can_post_comment_on_feed') && Phpfox::getUserParam('comment.can_post_comments')}
						{if (isset($aComment.iteration) && $aComment.iteration >= Phpfox::getParam('comment.total_child_comments')) || (isset($bForceNoReply) && $bForceNoReply) && !Phpfox::getService('user.block')->isBlocked(null, $aComment.user_id)}
