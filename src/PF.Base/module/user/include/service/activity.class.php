...
class User_Service_Activity extends Phpfox_Service
{
	...
	{		
        ...
        $this->database()->update($this->_sTable, ['activity_' . $sType => (int) (isset($aTotalItemInfo['total']) ? $aTotalItemInfo['total'] : $iItemTotal), 'activity_total' => $iTotal, 'activity_points' => $iPoints], ['user_id' => (int) $iUserId]);
