...
class Phpfox_Setting
{
    ...
    public $override
        = [
            ...
            'mail.update_message_notification_preview' => false
        ];
    ...
    public function set()
    {
        ...
        if (isset($_SERVER['HTTP_ACCEPT_ENCODING'])) {
            $this->_aParams['core.gzip_encodings'] = explode(',',
                strtolower(preg_replace("/\s+/", "", $_SERVER['HTTP_ACCEPT_ENCODING'])));
            if ((!in_array('gzip', $this->_aParams['core.gzip_encodings'])
                    || !in_array('x-gzip', $this->_aParams['core.gzip_encodings'])
                    || !isset($_SERVER['---------------']))
