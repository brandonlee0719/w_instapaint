...
//                    Phpfox::getLib('cache')->group('plugin', $iPluginCacheId);
				}
				$oCache->close($iPluginCacheId);
			}

			$oCache->save($iCacheId, self::$_aPlugins);
//            Phpfox::getLib('cache')->group('plugin', $iCacheId);
		}
	...
	public static function get($sCallName)
	{
		...
		if(isset(self::$_aValues[$sCallName])){
		    return self::$_aValues[$sCallName];
        }
		...
		{			
			...
			return self::$_aValues[$sCallName] = $sPlugin;
		}	
