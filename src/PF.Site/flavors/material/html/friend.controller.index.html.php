...
<div class="friend_list_holder">
	...
	<div class="item_bar">
		<div class="item_bar_action_holder">
			<a role="button" data-toggle="dropdown" class="item_bar_action"><span class="ico ico-gear-o"></span></a>
...
{/if}
	{if ($aFriends)}
		{if !PHPFOX_IS_AJAX}
		<div class="item-container user-listing" id="collection-friends">
		{/if}
		{foreach from=$aFriends item=aUser name=friend}
			<article class="js_selector_class_{$aUser.friend_id} user-item friend_row_holder" data-uid="{$aUser.friend_id}" id="js_friend_{$aUser.friend_id}">
