...
$Ready(function() {
  ...
  var total = 0,
      phrase = (!empty(core_twemoji_awesome_Phrases) &&
          !empty(core_twemoji_awesome_Phrases.emoji))
          ? core_twemoji_awesome_Phrases.emoji
          : 'Emoji';
  ...
  $('.global_attachment_list:not(._twa_built)').each(function() {
    ...
    t.append('<li><a href="' + PF.url.make('/emojis', {id: id}) +
        '" class="emoji-popup no_ajax js_hover_title"><i class="fa fa-smile-o"></i><span class="js_hover_info">' +
        phrase + '</span></a></li>');
  });
  ...
  if (cheatSheet.length) {
    ...
    for (var i in keys) {
      ...
      html += '<li><i class="twa twa-' + name + '"></i><span>:' + e +
          ':</span></li>';
    }
    html += '</ul>';
