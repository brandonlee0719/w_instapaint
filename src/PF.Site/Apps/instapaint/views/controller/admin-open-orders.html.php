...
{if $orders.open}
<div class="alert alert-info" role="alert"><i class="fas fa-box-open"></i> On this page you can see all the open orders on Instapaint.</div>
...
<div class="order container-fluid">
    ...
    <div class="row order-body">
        ...
        <div class="col-md-9">
            ...
            {else}
            <div class="order-body-description"><i class="far fa-clock"></i> This order hasn't been taken by a painter yet</div>
            {/if}
...
{/foreach}
{else}
<div class="alert alert-info" role="alert" style="margin-bottom: 0"><i class="fas fa-box-open"></i> There are no open orders at this moment.</div>
{/if}
