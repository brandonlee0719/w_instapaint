...
<div class="alert alert-info" role="alert"><i class="fas fa-clipboard-check"></i> To confirm the order approval click the blue button in the description below.</div>
...
<div class="order container-fluid">
    ...
    <div class="row order-body">
        ...
        <div class="col-md-9">
            ...
            <hr>
            <button id="submit-button" type="submit" class="btn btn-primary" name="_submit">Approve this order</button>
            </form>
        </div>
    </div>
</div>
