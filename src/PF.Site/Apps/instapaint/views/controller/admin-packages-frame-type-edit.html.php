...
<form method="post">
    <div class="form-group">
        ...
        <input id="name" type="text" name="val[name]" class="form-control"
               maxlength="255" required="required" value="{$frameType.name_phrase}"/>
    </div>
    <div class="form-group">
        <label class="control-label" for="description">Description</label>
        <input id="description" type="text" name="val[description]" class="form-control"
               maxlength="255" required="required" value="{$frameType.description_phrase}"/>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <a class="btn btn-danger pull-right" href="/admin-dashboard/packages/frame-type/delete/{$frameType.frame_type_id}/">Delete</a>
    </div>
</form>
{/if}
