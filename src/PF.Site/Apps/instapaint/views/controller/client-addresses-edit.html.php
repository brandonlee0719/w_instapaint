...
<form method="post">
    ...
    <div class="form-group">
        ...
        <div class="checkbox">
            <label>
                <input id="receive-saturday" name="val[can_receive_on_saturday]" type="checkbox" value="true" {if $val.can_receive_on_saturday}checked{/if}>
                Saturday
            </label>
            <label>
                <input id="receive-sunday" name="val[can_receive_on_sunday]" type="checkbox" value="true" {if $val.can_receive_on_sunday}checked{/if}>
                Sunday
            </label>
        </div>
    </div>
    ...
    <div class="form-group">
        <hr>
        <button type="submit" class="btn btn-primary" name="_submit">Update address</button>
    </div>
