...
<form method="post">
    <div class="form-group">
        ...
        <input id="name" type="text" name="val[name]" class="form-control"
               maxlength="255" required="required" value="{$shippingType.name_phrase}"/>
    </div>
    <div class="form-group">
        <label class="control-label" for="description">Description</label>
        <input id="description" type="text" name="val[description]" class="form-control"
               maxlength="255" required="required" value="{$shippingType.description_phrase}"/>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <a class="btn btn-danger pull-right" href="/admin-dashboard/packages/shipping-type/delete/{$shippingType.shipping_type_id}/">Delete</a>
    </div>
</form>
{/if}
