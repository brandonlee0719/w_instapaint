...
class AdminPackagesFrameTypeAddController extends \Phpfox_Component
{
    public function process()
    {
        ...
        if ($vals) { // Form was sent
            ...
            if (\Phpfox_Error::isPassed()) {
                $packagesService->addFrameType($vals['name'], $vals['description'], $vals['price']);
                $this->url()->send('admin-dashboard/packages',null,'New frame type was successfully added');
            }
        } else {
            ...
            // Set title
            $template->setTitle('Admin Dashboard » Add Frame Type');
            ...
            $template->setBreadCrumb('Add Frame Type');
            ...
            $template->buildSectionMenu('admin-dashboard', $instapaintService->insertMenuAfter(
                ...
                ['Add Frame Type' => 'admin-dashboard.packages.frame-type.add'] // Menu to be inserted
            ));
